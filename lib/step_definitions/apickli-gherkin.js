...
module.exports = function()
  ...
  this.When('I HEAD $resource', requestOptions, function(resource, callback) {
  ...
  this.When('I POST to $resource', requestOptions, function(resource, callback) {
  ...
  this.When('I PUT $resource', requestOptions, function(resource, callback) {
  ...
  this.When('I DELETE $resource', requestOptions, function(resource, callback) {
  ...
  this.When('I PATCH $resource', requestOptions, function(resource, callback) {
  ...
  this.When(/^I (GET|HEAD|POST|PUT|DELETE|PATCH) (.*) with variables/, requestOptions, function(method, resource, callback)
    ...
    if (method == 'POST' || method == 'PATCH' || method == 'PUT')
      ...
      while (this.apickli.requestBody.match(/\{\{([^}]+)\}\}/))
        {
        var value = this.apickli.getGlobalVariable(RegExp.$1) || '';
        this.apickli.requestBody = this.apickli.requestBody.replace('{{' + RegExp.$1 + '}}', value);
        }
      }

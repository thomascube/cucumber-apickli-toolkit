...
ApickliExt.prototype.patch = function(resource, callback)
  {
  return this.httprequest('PATCH', resource, callback);
  };
...
ApickliExt.prototype.storeValueOfResponseBodyPathInGlobalScope = function(path, name)
  ...
  this.setGlobalVariable(name, value ? value[0] : undefined);
  };

ApickliExt.prototype.setRequestHeader = function(name, value)
  {
  // this is an alias of addRequestHeader()
